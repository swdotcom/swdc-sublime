...
<p>
  <a href="https://packagecontrol.io/packages/CodeTime">
    <img alt="Code Time Installs" src="https://img.shields.io/packagecontrol/dt/CodeTime?style=flat-square&color=00b4ee&label=marketplace">
  </a>
</p>
...
[Code Time](https://www.software.com/code-time) is an open source plugin for automatic programming metrics and time tracking in Sublime Text. Track your productivity, protect valuable code time, and stay in flow.  
...
![Code Time features for Sublime Text](https://assets.software.com/readme/code-time/sublime/features-2.5.6.png)
...
Click **More data at software.com** in the Code Time view or visit [app.software.com](https://app.software.com) to see more advanced data visualizations. You will need to create a free Software account to use the web app. In the Code Time dashboard, you will be able to track: 
...
Have any questions? Create an issue in the [Code Time project](https://github.com/swdotcom/swdc-sublime) on GitHub or send us an email at [support@software.com](mailto:support@software.com) and we’ll get back to you as soon as we can.
